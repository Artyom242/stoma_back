            ...
            <div class="servic_section">
                <div class="servic_block">
                    <div class="block_cont">
                        <p>
                            Ультразвуковая чистка зубов – один из самых действенных и безопасных способов стоматологической чистки зубов. Профилактическая и лечебная процедура заключается в удалении налета и зубного камня с поверхности единиц с помощью ультразвукового скалера.
                        </p>
                    </div>
    ...
    <section>
        <div class="__container">
            <div class="descriptions_section">
                <div>
                    <h3 class="descriptions_title">Принцип действия ультразвуковой чистки зубов</h3>
                    <div class="descriptions_block">
                        <p>Базовое преимущество профессиональной процедуры в возможности безболезненного и безопасного удаления твердых зубных отложений. Их можно удалить и с помощью традиционной механической чистки – используя кюретки и крючки. Однако в этом случае не избежать повреждения поверхностного эмалевого слоя. Чистка камня ультразвуком базируется совершенно на другом принципе:</p>
                        <p>Примерно за 40-60 минут удается очистить от загрязнений все зубы во рту пациента. Судя по отзывам, первое, что ощущают обратившиеся сразу после сеанса чистки – это приятная гладкость поверхности зубов и свежесть дыхания.</p>
                        <p>Говоря о принципе действия ультразвуковой чистки зубов, нельзя не упомянуть о ее разновидностях. Выбор типа процедуры зависит от того, насколько много зубных отложений скопилось во рту у пациента.</p>
                        <p>Стандартная ультразвуковая чистка предполагает стандартное расположение скалера по отношению к поверхности зубов – перпендикулярное во всех направлениях. В ходе процедуры специалист использует дистиллированную воду.</p>
                        <p>Векторная ультразвуковая чистка зубов характеризуется обратным расположением скалера по отношению к поверхности зубов и корней – параллельным. Это значит, что вибрации ультразвука в этом случае распространяются исключительно в вертикальном направлении. Чтобы усилить эффект полировки зубной поверхности, вместо воды, во время сеанса используют раствор с гидроксиапатитом.</p>
                    </div>
                </div>
                <div>
                    <h3 class="descriptions_title">Показания к ультразвуковой чистке</h3>
                    <div class="descriptions_block">
                        <ul class="descriptions_block_list">
                            <li>изменение цвета зубов из-за коричневых или темно-желтых отложений;</li>
                            <li>образование глубоких пародонтальных карманов, при котором возникает гнилостный запах изо рта;</li>
                            <li>рецессия (опущение) десен;</li>
                            <li>частая кровоточивость десен во время приема пищи или чистки зубов;</li>
                            <li>чувствительность элементов зубного ряда к температурным перепадам;</li>
                            <li>подготовка к установке ортодонтических аппаратов, протезов, вживлению имплантов или другой хирургической манипуляции в ротовой полости;</li>
                            <li>рекомендация стоматолога, обнаружившего зубные отложения в промежутках между зубами и на внутренней поверхности единиц.</li>
                        </ul>
                    </div>
                </div>
                <div>
                    <h3 class="descriptions_title">Уход за зубами после чистки</h3>
                    <div class="descriptions_block">
                        <p>Чтобы исключить нежелательные осложнения и добиться наиболее очевидного результата ультразвуковой чистки зубов, пациенту следует соблюдать ряд врачебных рекомендаций после процедуры.</p>
                        <p>В течение первых 60-120 минут после профгигиены пациенту стоит воздержаться от приема пищи и напитков. Мера необходима для того, чтобы исключить раздражение чувствительной эмали. В течение первых суток после ультразвуковой чистки камней стоматологи также не советуют кушать слишком горячие, холодные блюда, кислое, сладкое и острое.</p>
                        <p>Первое время после профилактической процедуры для гарантии более устойчивого результата пациентам советуют не включать в рацион продукты, которые будут активизировать процесс образования мягкого пигментированного налета, например, сладости, кофе, черный чай, вино и пр.</p>
                        <p>Очевидный факт – после чистки зубы и вся полость рта нуждаются в тщательном домашнем уходе.</p>
                    </div>
                </div>
            </div>
        </div>
