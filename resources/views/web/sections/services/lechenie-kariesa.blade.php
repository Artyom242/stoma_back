            ...
            <div class="servic_section">
                <div class="servic_block">
                    <div class="block_cont">
                        <p>Кариес — это гниение зубной ткани, спровоцированное бактериями, которые населяют ротовую полость. Патология появляется из-за неправильной или недостаточной гигиены полости рта. Если кариес не лечить, он приведёт к сильной боли и может полностью разрушить зуб.</p>
                    </div>
            ...
            <div class="descriptions_section">
                <div>
                    ...
                    <div class="descriptions_block">
                        <p>Кариес — это самое распространенное заболевание на земле. Он встречается в каждом уголке планеты. Начинает свое развитие с безболезненного маленького пятнышка и развивается вплоть до полной потери зуба. Распространение кариесы зубов среди взрослого населения достигает 97-98%, среди детского 75-98%. Несмотря на значительные успехи в области профилактики кариеса зубов, распространенность кариеса в нашей стране не снижается.</p>
                        <p>Более научным языком, кариес – в переводе с латыни означает «гниение». Его вызывают бактерии — стрептококки. Они же провоцируют такие заболевания, как бронхит и ангину. Кариес это сложный, медленно текущий, патологический процесс.</p>
                    </div>
                </div>
                <div>
                    <h3 class="descriptions_title">Причины его возникновения:</h3>
                    <div class="descriptions_block">
                        <ul class="descriptions_block_list">
                            <li>патологии развития зубов во внутриутробном периоде;</li>
                            <li>наследственная предрасположенность;</li>
                            <li>гастрит, нервные расстройства, гипертония;</li>
                            <li>курение;</li>
                            <li>неправильный прикус;</li>
                            <li>патология слюнных желез;</li>
                            <li>недостаток кальция и фосфора;</li>
                            <li>сладкая, кислая, острая пища;</li>
                ...
                <div>
                    <h3 class="descriptions_title">С чего начинается диагностика?</h3>
                    <div class="descriptions_block">
                        <ul class="descriptions_block_list">
                            <li>визуальный осмотр;</li>
                            <li>трансиллюминация;</li>
                            <li>прицельный рентген-снимок;</li>
                            <li>кариес-маркеры (витальное окрашивание);</li>
                            <li>термопроба;</li>
                            <li>лазерная диагностика;</li>
                            <li>электроодонтометрия (используется при подозрении на пульпит).</li>
                        </ul>
                    </div>
                </div>
            </div>
