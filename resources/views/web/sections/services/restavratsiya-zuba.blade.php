            ...
            <div class="servic_section">
                <div class="servic_block">
                    <div class="block_cont">
                        <p>Формально реставрация по своей сути схожа с пломбированием, например, частью используемых материалов и рядом этапов. При этом, нельзя сравнивать результаты, поскольку эстетические реставрационные манипуляции гарантируют безупречность улыбки.</p>
                    </div>
    ...
    <section>
        <div class="__container">
            <div class="descriptions_section">
                <div>
                    <h3 class="descriptions_title">Что нужно знать о реставрации зубов?</h3>
                    <div class="descriptions_block">
                        <p>Если требуется восстановление анатомической формы зубов, их эстетических свойств и практически полноценной функциональности, то для достижения желаемого эффекта потребуется целый ряд процедур. Реставрация зубов – это комплекс стоматологических мер по восстановлению и корректировке формы и цвета. Используемые материалы позволяют максимально точно имитировать природные ткани, гарантируя эстетичность результата.</p>
                    </div>
                </div>
                <div>
                    ...
                    <div class="descriptions_block">
                        <ul class="descriptions_block_list">
                            <li>Сравнительно быстрое получение желаемого результата. Восстановленный зуб визуально не отличается от остальных в ряду. Упор процедуры делается именно на максимальную эстетичность.</li>
                            <li>Долговечность. На материалы и выполненную работу дается гарантия сроком до 10-15 лет.</li>
                            <li>Прочность. В результате реставрации гарантируется восстановление функциональности зуба – он получается таким же прочным, как и остальные. После процедуры нет надобности делать корректировку и дополнительно посещать стоматолога.</li>
                            <li>Неприхотливость в уходе. Достаточно соблюдать правила элементарной гигиены полости рта, и не использовать абразивные пасты и жесткие щетки.</li>
                            <li>Устойчивость к агрессивным средам. Используемые при реставрации материалы имеют высокую стойкость к воздействию большинства пищевых красителей. Менее стойки они только к воздействию табачного дыма (при активном курении) и красного вина.</li>
                        </ul>
                        <p>Кроме этого, к преимуществам можно отнести сведенный к минимуму риск повторного появления кариеса и других заболеваний, которые привели к частичному разрушению зуба и необходимости его восстановления.</p>
                    </div>
                </div>
                <div>
                    <h3 class="descriptions_title">Недостатки и нюансы</h3>
                    <div class="descriptions_block">
                        <ul class="descriptions_block_list">
                            <li>Необходимость бережного отношения. Каким бы прочным не был результат реставрации, а все же остается риск, что восстановленная часть может сломаться. Чтобы избежать этого, необходимо бережно относиться к зубам и не грызть твердые предметы (например, орехи, сухарики, ногти, проволоку, нитки и т.д.).</li>
                            <li>Не полностью восстановленная жевательная функция. Художественная реставрация зубов это процедура, которая направлена на возвращение эстетических свойств. Жевательная функция, при этом, восстанавливается не полностью. Обратите внимание, что в некоторых случаях вместо восстановления лучше воспользоваться услугой полноценного протезирования.</li>
                            <li>Относительно высокая стоимость процедуры. Этот нюанс закономерен в сравнении с пломбированием. Реставрация требует большого опыта от врача и грамотного подбора материалов (в том числе и по цвету).</li>
                        </ul>
                        <p>Стоит отметить и еще один нюанс – при реставрации непрямым методом, результат вы получите не после первого посещения стоматолога. Кроме того, появляется необходимость регулярного посещения врача для примерки и корректировки стоматологических конструкций.</p>
                    </div>
                </div>
            </div>
        </div>
